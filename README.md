...
```
openemr_smart-on-fhir/      SMART-on-FHIR app, OpenEMR version (FastAPI, EHR launch, PKCE) +
                        Modal serving script and demo seeding script
epic_smart-on-fhir/         SMART-on-FHIR app, Epic-sandbox version (static HTML + fhirclient) +
                        CORS-enabled Modal serving script
