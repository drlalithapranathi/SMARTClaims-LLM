#!/usr/bin/env python3
"""
BLEU evaluation for qwen3-32b-mimic-cpt-200k-ep2 (CPT model).

Run:
    python eval_bleu_ep2.py
"""
...
ADAPTER_DIR    = "qwen3-32b-mimic-cpt-200k-ep2"
...
for _, row in tqdm(eval_df.iterrows(), total=len(eval_df), desc="Generating"):
    ...
    # Truncate reference to same word count as generated text for fair BLEU
...
samples_path = f"{OUTPUT_DIR}/bleu_samples_{ADAPTER_DIR}_{ts}.csv"
...
summary_path = f"{OUTPUT_DIR}/bleu_summary_{ADAPTER_DIR}_{ts}.csv"
