#!/usr/bin/env python3
"""
BLEU / ROUGE / Perplexity evaluation — CPT epoch 2 model on radiology reports.
...
Run:
    python bleu_rouge_radiology_cpt.py
"""
...
print("\n" + "=" * 60)
print(f"  Model         : {BASE_MODEL} + {ADAPTER_DIR}")
