#!/usr/bin/env python3
"""Build SFT v9 and GRPO v9 datasets for radiology CPT-code prediction.

Combines radiology admissions (from the SFT train CSV) with a sample of
discharge notes labelled 'unknown' (~20% of the final SFT set), then writes:
...
UNKNOWN_FRACTION = 0.20     # share of the final SFT set labelled 'unknown'
VAL_FRACTION = 0.1
SEED = 42

SFT_TRAIN_OUT = "sft_v9_train_dataset"
SFT_VAL_OUT = "sft_v9_val_dataset"
GRPO_TRAIN_OUT = "grpo_v9_train_dataset"
GRPO_VAL_OUT = "grpo_v9_val_dataset"
